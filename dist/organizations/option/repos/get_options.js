...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/actions/organizations/option/repos/get_options.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/actions/organizations/option/repos/get_options.ts":
/*!***************************************************************!*\
  !*** ./src/actions/organizations/option/repos/get_options.ts ***!
  \***************************************************************/
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar helper_1 = __webpack_require__(/*! ../../../../utils/helper */ \"./src/utils/helper.ts\");\r\nvar constants_1 = __webpack_require__(/*! ../../../../utils/constants */ \"./src/utils/constants.ts\");\r\nvar organizationRepoList = [];\r\nif (options.organizations) {\r\n    var organizationRepoResponse = httpGet(options.organizations.repos_url + \"?_=\" + new Date().getTime(), {\r\n        Authorization: 'token ' + constants_1.accessToken,\r\n    });\r\n    var organizationRepoResponseObject = helper_1.decodeApiResponse(organizationRepoResponse);\r\n    organizationRepoList = organizationRepoResponseObject.response;\r\n}\r\nexports.default = (function () {\r\n    return JSON.stringify({\r\n        add: organizationRepoList.map(function (repo) {\r\n            return {\r\n                name: repo.full_name,\r\n                id: repo.id,\r\n                html_url: repo.html_url,\r\n                description: repo.description\r\n            };\r\n        }),\r\n    });\r\n});\r\n\n\n//# sourceURL=webpack://main/./src/actions/organizations/option/repos/get_options.ts?");
